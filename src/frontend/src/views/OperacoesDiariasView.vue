            ...
            <table class="min-w-full text-left divide-y divide-white/20">
              <thead class=" ">
                <tr class="text-xl">
                  ...
                  <th class="p-3" v-if="motivo === MotivoTransacoes.Transferencia">Origem</th>
                  <th class="p-3" v-if="motivo === MotivoTransacoes.Transferencia">Destino</th>
                  <th class="p-3">Qtd</th>
              ...
              <tbody class="divide-y divide-white/10">
                ...
                >
                  ...
                  <td class="p-3" v-if="motivo === MotivoTransacoes.Transferencia">
                    <span class="opacity-90">{{ i.localOrigem }}</span>
                  </td>
