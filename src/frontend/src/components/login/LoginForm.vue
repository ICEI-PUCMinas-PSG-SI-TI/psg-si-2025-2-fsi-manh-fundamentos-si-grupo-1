    ...
    <div class="relative w-full max-w-md sm:max-w-lg lg:max-w-xl">
      ...
      <div class="flex justify-center">
        <form @submit.prevent ="login"
          class="w-100 h-100 pt-25 mt-20 bg-gray-300 bg-opacity-90 rounded- shadow-xl p-8 flex flex-col gap-4 text-white"
        >
          <!-- Usuário -->

          <div
            class="flex items-center bg-gray-700 px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400 transition"
          >
            <svg
          ...
          <button
            type="submit"
            class="cursor-pointer mt-4 w-full bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 transition transform hover:scale-105"
            >
            Login
          </button>
