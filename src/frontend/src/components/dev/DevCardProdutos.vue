...
async function gerar() {
  const res = await apiFaker.criarProdutos(recurse.value, quant.value)
  if (res.ok) {
    notificacoes.addNotification('produtos criados com sucesso!', { time: 3000 })
  }
}
  ...
  <div class="card bg-base-100 border-base-300 border-2">
    <div class="card-body">
      <div class="flex flex-col gap-2 p-2">
        <div class="mb-4 text-xl font-semibold">Produtos</div>
        <strong>Criar produtos com dados aleatórios</strong>
        ...
        <hr />
        <p><strong>Deletar todos os produtos.</strong></p>
        <p>
        ...
        <hr />
        <p><strong>Deletar produtos por ID</strong></p>
        <p>
          Observação: Isso também ira deletar outras informações associadas as {entidades}
          deletadas.
        </p>
